  ...
  return (
    <>
      <Typography align="justify" variant="body2" color="textSecondary">
        Taco Grille LLC &copy; (referred to as the Company) does not promise
        that the information provided on this webpage is accurate or up to date.
        The Company is not liable for user attempts to drive on I-80 in
        inclement weater, not to drive on I-80 in good weather, or unwarranted
        Pisten Bully purchases. Furthermore, the Company is not responsible at
        all for deciding whether or not I-80 is open, so please do not call the
        Company with questions regarding the motives of I-80 closures or
        forecasts for road reopening / reclosing.
      </Typography>
      <Typography align="justify" variant="body2" color="textSecondary">
